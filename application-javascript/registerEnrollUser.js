...
const { buildCAClient, registerAndEnrollUser } = require('/home/fabric-user/fabric-samples/test-application/javascript/CAUtil.js');
const { buildCCPOrg1, buildCCPOrg2, buildWallet } = require('/home/fabric-user/fabric-samples/test-application/javascript/AppUtil.js');
